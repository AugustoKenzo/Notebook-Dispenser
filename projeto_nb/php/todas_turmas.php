...
<?php endif;?>
    <table class="table" style="margin-top: 40px;">
        ...
        <tr>
            ...
            <?php if($dado2['nivel'] == 'Administrador'):?>
            <th><a role="button" class="btn btn-success btn-sm" style="color: white;" href="editar_turma.php?id=<?php echo $item['id']?>">EDITAR</a>
            <a role="button" class="btn btn-danger btn-sm" style="color: white;" href="excluir_turma.php?id=<?php echo $item['id']?>">EXCLUIR</a></th>
            <?php endif;?>
        </tr>
        <?php
                }
